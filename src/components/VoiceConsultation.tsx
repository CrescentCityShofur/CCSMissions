              ...
              function: {
                ...
                parameters: {
                  ...
                  properties: {
                    ...
                    meetingType: { type: "string", enum: ["virtual", "onsite"], description: "Virtual or on-site consultation" },
    ...
    <div className="flex flex-col items-center gap-4">
      ...
      {status === "listening" && (
        <div className="flex flex-col items-center gap-6">
          ...
          <button
            onClick={endCall}
            className="px-8 py-3 border border-red-400/50 text-red-400 text-xs uppercase tracking-widest rounded-lg hover:bg-red-400/10 transition-all"
          >
            End Call
          </button>
        </div>
      ...
      {status === "done" && (
        <div className="glass-panel p-8 text-center max-w-md">
          <p className="font-cinzel text-gold text-lg uppercase tracking-widest mb-3">
          ...
          <p className="text-xs text-gold/60 tracking-widest uppercase mt-4 animate-pulse">
